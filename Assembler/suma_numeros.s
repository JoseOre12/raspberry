...
loop:
    ...
    cmp r0, #10         /* comprobar fin de línea (LF = 10) */
    beq end_number

    sub r0, r0, #48     /* convertir ASCII a número */
    mov r1, r6
    mov r2, #10
    mul r1, r1, r2      /* multiplicar número actual por 10 */
    add r6, r1, r0      /* añadir nuevo dígito */
